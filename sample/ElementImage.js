...
/**
 * Handles the 'add image element' window UI triggered by the toolbar 'Image' button.
 * @class ElementImage
 */
class ElementImage {
    /**
    ...
    _initLibraryUi() {
        ...
        this.ELEMENTS.listwrap.classList.add('element-image-list');
        ...
        for (i = 0; i < this.IMAGE_LIST.length; i++) {
            ...
            d.classList.add('element-image-list-item');
    ...
    _initSearchUi() {
        ...
        this.ELEMENTS.searchwrap.classList.add('element-image-search');
        this.TARGET.appendChild(this.ELEMENTS.searchwrap);

        const title = document.createElement('h3');
        title.textContent = 'Search for images';
        this.ELEMENTS.searchwrap.appendChild(title);

        this.ELEMENTS.input = document.createElement('input');
        this.ELEMENTS.input.id = 'element-image-search-input';
    ...
    _clearSearchEventHandler(e) {
        ...
        const list = this.ELEMENTS.listwrap.querySelectorAll('.element-image-list-item');
