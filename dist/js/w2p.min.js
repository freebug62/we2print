  ...
  return _createClass(MainWindow, [{
    ...
    value: function _renderPages(side, measure) {
      ...
      wrapper.addEventListener('mousedown', function (e) {
        ...
        _this5._deselectAllElements(e.currentTarget);
      });
    ...
    key: "_deselectAllElements",
    value: function _deselectAllElements(page) {
      page.querySelectorAll('.w2p-element-wrap').forEach(function (element) {
        // get child element.
    ...
    value: function _moveWrapper(element) {
      ...
      document.addEventListener('mouseup', function () {
        ...
        var completelyOffRight = left > pageW;
        var completelyOffLeft = left + w < 0;
        var completelyOffBottom = top > pageH;
        var completelyOffTop = top + h < 0;
        var fullyOut = completelyOffRight || completelyOffLeft || completelyOffBottom || completelyOffTop;
        if (fullyOut) {
          ...
          for (var _i = 0, _corners = corners; _i < _corners.length; _i++) {
            var c = _corners[_i];
            var dx = centerX - (c.x + w / 2);
            var dy = centerY - (c.y + h / 2);
            var d = dx * dx + dy * dy;
            if (d < minDist) {
              minDist = d;
              nearest = c;
          ...
          wrap.style.left = "".concat(nearest.x, "px");
          wrap.style.top = "".concat(nearest.y, "px");
